...
exports.getUser = async (req, res) => {
    try {
        ...
        if (!id) {
            return respuesta.error(req, res, 'No se envió el campo: ID', 400);
        }
        ...
        respuesta.success(req, res, { user: userWithoutPassword }, 200);
...
exports.updateUser = async (req, res) => {
    try {
        ...
        // Respuesta exitosa
        respuesta.success(req, res, 'Datos del usuario actualizados exitosamente', 200);
...
exports.deleteUser = async (req, res) => {
    try {
        ...
        if (!id) {
            return respuesta.error(req, res, 'No se envió el parámetro: ID', 400);
        }
        ...
        respuesta.success(req, res, { message: 'Usuario eliminado con éxito' }, 200);
